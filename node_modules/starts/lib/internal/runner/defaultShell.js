...
function spawn(command, spawnOpts) {
    var shellDetails = getShell();
    var args = shellDetails.executeFlags.split(' ');
    return childProcess.spawn(shellDetails.shell, args.concat([command]), spawnOpts);
}
exports.spawn = spawn;
